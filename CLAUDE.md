...
- **Two Monthly events are currently invisible for want of an ordinal phrase (found 2026-07-29, NOT yet fixed — needs Alexandra's approval).** Both violate data-quality rule 9 and therefore render nowhere:
  ...
  - **id 588 Movies on the Green — Mill Valley** — `cadence: Monthly`, `day: Friday`, notes list "Jul 7, Aug 4, Sep 8, Oct 6." Those four dates are all **Tuesdays in 2026** but were all **Fridays in 2023** — the record is carrying 2023 dates. Needs source re-verification before any fix; do not guess.
